...
Requires:          nginx-galaxy-filesystem = %{epoch}:%{version}-%{release}

%if 0%{?rhel} || 0%{?fedora} < 24
# Introduced at 1:1.10.0-1 to ease upgrade path. To be removed later.
Requires:          nginx-galaxy-all-modules = %{epoch}:%{version}-%{release}
%endif
...
Requires:          nginx-galaxy-mimetypes
%endif
Provides:          webserver
...
Requires:          nginx-galaxy-mod-http-geoip = %{epoch}:%{version}-%{release}
Requires:          nginx-galaxy-mod-http-image-filter = %{epoch}:%{version}-%{release}
Requires:          nginx-galaxy-mod-http-perl = %{epoch}:%{version}-%{release}
Requires:          nginx-galaxy-mod-http-xslt-filter = %{epoch}:%{version}-%{release}
Requires:          nginx-galaxy-mod-mail = %{epoch}:%{version}-%{release}
Requires:          nginx-galaxy-mod-stream = %{epoch}:%{version}-%{release}
...
%prep
%setup -q -n nginx-%{version} -a 2 -a 3
%patch0 -p0
cp %{SOURCE200} .
cp %{SOURCE210} .
