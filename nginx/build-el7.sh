...
srpm7='https://dl.fedoraproject.org/pub/epel/7/SRPMS/n/nginx-1.10.2-1.el7.src.rpm'
...
su - build -c "curl -L -o ~/rpmbuild/SOURCES/2.2-nfs.tar.gz https://github.com/natefoo/nginx-upload-module/archive/2.2-nfs.tar.gz"
